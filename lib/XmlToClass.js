...
${formatedClass.toString().replace(/,/g,'<br/>')}
  ...
  function getPropertieName(name){

  }

  function removeUnderscore(l){
    var index = this.indexOf(l);
    var newChar = this.charAt(++index).toUpperCase();
    var oldChar = this.charAt(index);
